          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form action="?page=video/proses-tambah" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <textarea type="text" name="deskripsi1_video" class="form-control" id="deskripsi1_video" 
                        placeholder="Masukan deskripsi1 video" required> </textarea>
                     
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Deskripsi 2</label>
                      <textarea type="text" name="deskripsi2_video" class="form-control" id="deskripsi2_video" 
                        placeholder="Masukan deskripsi1 video" required> </textarea>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="link_video" class="form-control" id="link_video" 
                        placeholder="Masukan link video" required>
